...
Сравним теорему 3 с предшествующими результатами. В частном случае $t^p$, $p=1$, $X=Q$ --- куб в $\mathbb{R}^n$ ее утверждение было получено другим, значительно более сложным способом в работе С.~Спанне [3]. Теорема 2 для функций $\varphi(t)=t^p$ при $0<p\le 1$ дает усиление этого результата, так как условие (\ref{eqEsimateOfModulusByMu}) тем сильнее, чем меньше $p$.
